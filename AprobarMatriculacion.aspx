<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AprobarMatriculacion.aspx.cs" Inherits="WSFUriasoft.AprobarMatriculacion" %>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-2">
					 <asp:DropDownList ID="Cursosest" runat="server"></asp:DropDownList>
				</div>
				<div class="col-md-2">
				</div>
				<div class="col-md-2">
														...
														<tr>
															<td width="560px" style="text-align: justify; padding: 0.4em;">
																<asp:Panel ID="Panel1" runat="server">
																	...
																	<asp:Button ID="Aprobar" runat="server" Text="Aprobar" class="btn btn-primary"/>
																	<asp:Button ID="Rechazar" runat="server" Text="Rechazar" class="btn btn-danger"/>
																	</div>
																</asp:Panel>
															</td>
														</tr>
